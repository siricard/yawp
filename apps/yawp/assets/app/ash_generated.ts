...
export type UpsertDevicePushTokenFields = UnifiedFieldSelection<DevicePushRegistryResourceSchema>[];

export type InferUpsertDevicePushTokenResult<
  Fields extends UpsertDevicePushTokenFields | undefined,
> = InferResult<DevicePushRegistryResourceSchema, Fields>;

export type UpsertDevicePushTokenResult<Fields extends UpsertDevicePushTokenFields | undefined = undefined> = | { success: true; data: InferUpsertDevicePushTokenResult<Fields>; }
| { success: false; errors: AshRpcError[]; }

;

/**
 * Create a new DevicePushRegistry
 *
 * @ashActionType :create
 */
export async function upsertDevicePushToken<Fields extends UpsertDevicePushTokenFields | undefined = undefined>(
  config: {
  tenant?: string;
...
): Promise<UpsertDevicePushTokenResult<Fields extends undefined ? [] : Fields>> {
  const payload = {
  ...
  return executeActionRpcRequest<UpsertDevicePushTokenResult<Fields extends undefined ? [] : Fields>>(
    payload,
    config
  );
}
...
/**
 * Validate: Create a new DevicePushRegistry
 *
 * @ashActionType :create
 * @validation true
 */
export async function validateUpsertDevicePushToken(
  config: {
  tenant?: string;
  input: UpsertDevicePushTokenInput;
  headers?: Record<string, string>;
...
export type UpsertNotificationPreferenceFields = UnifiedFieldSelection<NotificationPreferenceResourceSchema>[];

export type InferUpsertNotificationPreferenceResult<
  Fields extends UpsertNotificationPreferenceFields | undefined,
> = InferResult<NotificationPreferenceResourceSchema, Fields>;

export type UpsertNotificationPreferenceResult<Fields extends UpsertNotificationPreferenceFields | undefined = undefined> = | { success: true; data: InferUpsertNotificationPreferenceResult<Fields>; }
| { success: false; errors: AshRpcError[]; }
 ...
 * @ashActionType :create
 */
export async function upsertNotificationPreference<Fields extends UpsertNotificationPreferenceFields | undefined = undefined>(
  config: {
  tenant?: string;
...
): Promise<UpsertNotificationPreferenceResult<Fields extends undefined ? [] : Fields>> {
  const payload = {
  ...
  return executeActionRpcRequest<UpsertNotificationPreferenceResult<Fields extends undefined ? [] : Fields>>(
    payload,
    config
  );
}
...
/**
 * Validate: Create a new NotificationPreference
 *
 * @ashActionType :create
 * @validation true
 */
export async function validateUpsertNotificationPreference(
  config: {
  tenant?: string;
  input: UpsertNotificationPreferenceInput;
  headers?: Record<string, string>;
