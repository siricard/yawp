defmodule Yawp.Chat.MessageTest do
  ...
  describe "create/1" do
    ...
    test "ciphertext_envelope and home_server are nullable and accept values" do
      ...
      assert msg.home_server == "yawp.example"
    end
  end
    ...
    test "deleting a room cascades and removes its messages (on_delete: :delete_all)" do
      ...
      {:ok, _msg} =
        ...
        |> Ash.create()
                        ...
                        Yawp.Repo.delete_all(from(r in "rooms", where: r.id == type(^room.id, :binary_id)))
