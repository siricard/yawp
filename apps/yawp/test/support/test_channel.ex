defmodule YawpWeb.TestChannel do
  @moduledoc """
  ...
  `YawpWeb.UserSocket.connect/3`) and therefore propagates to every
  ...
  `YawpWeb.UserSocket` because `Phoenix.ChannelTest.subscribe_and_join/4`
