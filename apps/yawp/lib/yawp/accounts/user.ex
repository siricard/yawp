defmodule Yawp.Accounts.User do
  use Ash.Resource,
    otp_app: :yawp,
    domain: Yawp.Accounts,
  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender Yawp.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource Yawp.Accounts.Token
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender Yawp.Accounts.User.Senders.SendPasswordResetEmail
        ...
        case Ash.Changeset.get_attribute(changeset, :public_key) do
          pk when is_binary(pk) ->
            Ash.Changeset.force_change_attribute(
              changeset,
              :did,
              Yawp.Identity.did_from_pubkey(pk)
            )
