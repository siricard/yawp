defmodule YawpWeb.WhoamiChannel do
  @moduledoc """
  Tiny `whoami` channel used by clients to confirm — at the SOCKET level —
  that the token presented to `YawpWeb.UserSocket.connect/3` was valid
  ...
  See:
    * `lib/yawp_web/channels/user_socket.ex` for the token verification.
